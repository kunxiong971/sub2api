export default {
    ...
    channelMonitor: {
      ...
      form: {
        ...
        apiModeImagesHint: '使用 /v1/images/generations 生图探活，判定「2xx + 返回图片数据」；适合纯生图上游（gpt-image 系）。',
        endpoint: '上游地址',
        ...
        imageMode: '图片模型监控',
        imageModeHint: '生图模型的响应没有文本；开启后按「HTTP 2xx + 响应体非空」判定可用（配合「覆盖」模式的生图请求体使用），关闭则按文本响应判定。',
        groupName: '分组名称',
