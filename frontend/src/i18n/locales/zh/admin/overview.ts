export default {
    ...
    users: {
      ...
      filterOwn: '仅自建',
      deleteManaged: '删除',
      deleteManagedConfirm: '确定删除工作台托管密钥「{name}」吗？工作台下次注入会自动重建一把。',
      managedKeyDeleted: '托管密钥已删除',
      deleteManagedFailed: '删除托管密钥失败',
      cleanupOrphans: '清理孤儿托管密钥',
      cleanupOrphansConfirm: '清理所有分组已被删除的工作台托管密钥？该操作只影响托管密钥，用户自建密钥不受影响。',
      cleanupOrphansDone: '已清理 {count} 把孤儿托管密钥',
      cleanupOrphansNone: '没有需要清理的孤儿托管密钥',
      cleanupOrphansFailed: '清理孤儿托管密钥失败',
      group: '分组',
      none: '无',
    ...
    groups: {
      ...
      deleteConfirmManagedKeys: '将同时清理 {count} 把工作台托管密钥。',
      columns: {
        name: '名称',
        id: 'ID',
        platform: '平台',
