export default {
    ...
    channelMonitor: {
      ...
      form: {
        ...
        apiModeImages: 'Images API',
        apiModeImagesHint: 'Probes /v1/images/generations and judges success by "2xx + image data returned"; ideal for image-only upstreams (gpt-image family).',
        ...
        imageMode: 'Image Model Monitoring',
        imageModeHint: 'Image generation responses contain no text. When enabled, success is judged by "HTTP 2xx + non-empty response body" (use with the "Override" request body); otherwise text-based judgment applies.',
