...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	playgroundConfigRepository := repository.NewPlaygroundConfigRepository(db)
	...
	playgroundConfigService := service.NewPlaygroundConfigService(playgroundConfigRepository, adminService, groupRepository, channelMonitorService, modelPricingResolver)
	apiKeyHandler := handler.NewAPIKeyHandler(apiKeyService, authService, playgroundConfigService)
	...
	playgroundHandler := admin.NewPlaygroundHandler(playgroundConfigService)
	upstreamBillingProbeService := service.ProvideUpstreamBillingProbeService(accountRepository, accountTestService, settingService, leaderLockCache, db)
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, grokOAuthHandler, cnProviderHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, pluginHandler, adminAPIKeyHandler, scheduledTestHandler, channelHandler, channelMonitorHandler, channelMonitorRequestTemplateHandler, contentModerationHandler, promptAdminHandler, paymentHandler, affiliateHandler, complianceHandler, auditLogHandler, playgroundHandler, upstreamBillingProbeService, ollamaCloudUsageService)
